...
func (m *Match) gameStage() {
	...
	case StageRoom5:
		if m.starTower.Step == 1 {
			...
			if m.starTower.ensureConstellationSymbol() {
...
//room3
func (m *Match) ensureCandlesColor() {
...
//room4
func (m *Match) ensureMagicStandsPowerOn() {
...
func (m *Match) ensureMagicStandsPowerFul() {
	for _, v := range m.magicLab.Stands {
		if !v.IsPowerful {
			return false
		}
...
//room5
func (m *Match) ensureConstellationSymbol() {
...
func (m *Match) ensureElementSymbol() {
